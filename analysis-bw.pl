...
% 1. Shape
domainAffordanceClassifier([[], [attr(has_shape(b1, cube)), attr(has_shape(b1, cuboid))]]).
domainAffordanceClassifier([[attr(has_shape(b1, prism))], []]).
% 2. Size
domainAffordanceClassifier([[attr(has_size(b1, small))], [attr(has_size(b2, medium)), attr(has_size(b2, small))]]).
domainAffordanceClassifier([[attr(has_size(b1, small)), attr(has_size(b2, big))], []]).
domainAffordanceClassifier([[attr(has_size(b2, big))], [attr(has_size(b1, big)), attr(has_size(b1, medium))]]).
